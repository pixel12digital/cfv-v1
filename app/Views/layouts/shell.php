        ...
        <div class="app-main">
            ...
            <aside class="sidebar" id="sidebar">
                <nav class="sidebar-menu">
                    <?php
                    $currentRole = $_SESSION['active_role'] ?? $_SESSION['current_role'] ?? 'ALUNO';
                    ...
                    foreach ($menuItems as $item):
                        ...
                        if (isset($item['submenu'])):
                            ...
                            foreach ($item['submenu'] as $subitem) {
                                if (strpos($currentPath, $subitem['path']) === 0) {
                    ...
                    ?>
                        <div class="sidebar-menu-item-wrapper">
                            <button type="button" class="sidebar-menu-item sidebar-menu-toggle <?= $hasActiveSubmenu ? 'active' : '' ?>" data-submenu-toggle>
                    ...
                    <?php else:
                        $isActive = isset($item['path']) && strpos($currentPath, $item['path']) === 0;
                    ?>
    ...
    $menus = [
        'ADMIN' => [
            ...
            [
                ...
                'submenu' => [
                    ['path' => '/relatorio-alunos-status', 'label' => 'Alunos por Status'],
                    ['path' => '/relatorio-aulas', 'label' => 'Aulas por Período'],
                    ['path' => '/relatorio-quilometragem', 'label' => 'Quilometragem'],
                    ['path' => '/relatorio-transacoes', 'label' => 'Transações Financeiras'],
                    ['path' => '/relatorio-turmas-teoricas', 'label' => 'Turmas Teóricas'],
                    ['path' => '/relatorio-presenca-teorica', 'label' => 'Presença Teórica'],
                ]
            ],
